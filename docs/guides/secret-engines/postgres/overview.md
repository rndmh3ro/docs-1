...
You can easily manage [PostgreSQL Database secret engine](https://www.vaultproject.io/api/secret/databases/postgresql.html) using KubeVault operator.
...
In this tutorial, we will create [role](https://www.vaultproject.io/api/secret/databases/index.html#create-role) using PostgresRole and issue credential using DatabaseAccessRequest. For this tutorial, we are going to deploy Vault using KubeVault operator.
